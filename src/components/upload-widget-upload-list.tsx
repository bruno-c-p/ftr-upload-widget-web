    ...
    <div className="px-3 flex flex-col gap-3">
      ...
      <ScrollArea.Root type="scroll" className="overflow-hidden">
        ...
        <ScrollArea.Scrollbar
          className="flex touch-none bg-zinc-800 p-0.5 transition-colors duration-[160ms] ease-out data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
          orientation="vertical"
        >
          <ScrollArea.Thumb className="relative flex-1 bg-zinc-600 rounded-[10px] before:absolute before:left-1/2 before:top-1/2 before:size-full before:min-w-11 before:translate-x-1/2 before:-translate-y-1/2" />
        </ScrollArea.Scrollbar>
      </ScrollArea.Root>
    </div>
  )
